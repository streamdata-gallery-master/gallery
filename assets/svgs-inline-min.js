jQuery(document).ready(function($) {
  if (
    ...
    var t = 'img.' !== cssTarget.Bodhi ? cssTarget.Bodhi : 'img.style-svg'
    ...
    i.endsWith('svg') &&
      $.get(
        ...
        function(i) {
          ...
          void 0 === r
            ? void 0 === a
              ? ((r = 'svg-replaced-' + t), (n = n.attr('id', r)))
              : (r = a)
            : (n = n.attr('id', r)),
            void 0 !== s &&
              (n = n.attr('class', s + ' replaced-svg svg-replaced-' + t)),
            (n = n.removeAttr('xmlns:a')),
            e.replaceWith(n),
            $(document).trigger('svg.loaded', [r])
        },
        'xml'
      )
  })
